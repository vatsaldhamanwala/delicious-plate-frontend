    ...
    <>
        ...
        <form onSubmit={handleLogin}>
            ...
            <div className=' rounded-lg w-full max-w-lg mx-auto mt-15 '>
                ...
                <input id='username' autoComplete='name' value={username} onChange={(event)=> setUsername(event.target.value)} type="text" required placeholder='Enter your username' className='outline-none w-full py-2 px-4 border-gray-400 border placeholder-gray-500  rounded-lg focus:border-orange-500 focus:outline-none bg-white' />
            </div >
            ...
            <div className=' rounded-lg w-full max-w-lg mx-auto mt-4 '>
                ...
                <div className='relative'>
                    <input id='password' autoComplete='new-password' type={showPassword ? "text": "password"} value={password} onChange={(event)=> setPassword(event.target.value)} placeholder='Enter your password' className='outline-none w-full py-2 px-4 border-gray-400 border placeholder-gray-500  rounded-lg focus:border-orange-500 focus:outline-none bg-white' />    
